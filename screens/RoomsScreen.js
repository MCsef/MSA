            ...
            <View style={styles.viewButtonStyle}> 
              <View style={styles.viewBackgroundStyle}>
                <View style={styles.viewStyle}>
                  ...
                  <Text style={styles.roomsText}>{`${item.description}`}</Text><Text></Text>
                  <Text style={styles.roomsText}>Duration: {`${item.time}`} min</Text>
                  <Text style={styles.roomsText}>Game available in {`${item.language}`}</Text><Text></Text>
                  <Text style={styles.roomsText}>*{`${item.roomPrice}`} lei/room</Text>
                  <Text style={styles.roomsText}>**{`${item.clientPrice}`} lei/person</Text>
